...
// Only files that actually exist under /public/products. Other catalog
// paths still point at missing photos, so we skip those requests and
// let ProductImage show the AC placeholder instead.
const AVAILABLE_IMAGES = new Set(["/products/shampoo_sixteen_3.png"]);

export function getProductImageSrc(product) {
  return AVAILABLE_IMAGES.has(product.image) ? product.image : undefined;
}
