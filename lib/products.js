...
// Other catalog entries still point at missing .jpg files, so those stay
// as the gray "AC" placeholder until their photos are added.
const AVAILABLE_PRODUCT_PHOTOS = new Set(["/products/shampoo_sixteen_3.png"]);
