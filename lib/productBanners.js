...
const SIX_FREE_ITEMS = [
  {
    title: "무오일",
    copy: "모공을 막을 수 있는 오일은 한 방울도 넣지 않았습니다.",
  },
  {
    title: "무방부제",
    copy: "방부제를 넣지 않았습니다.",
  ...
  {
    title: "무향료",
    copy: "자극이 될 수 있는 합성 향료를 넣지 않았습니다.",
  },
  {
    title: "무알코올",
    copy: "피부를 건조하게 만들 수 있는 알코올을 배제했습니다.",
  },
  {
    title: "무색소",
...
const bannersByProductId = {
  ...
  "moisture-glow-treatment": {
    ...
    heading: "건강한 헤어 미스트로,\n보석처럼 빛나는 머리결",
    intro:
      "엔클로이 모발 & 두피 미스트는 올내추럴 처방으로, 모든 모발 타입에 윤기와 힘을 더합니다. 큐티클을 부드럽게 열어 저분자 수분이 손상된 결에 닿도록 돕고, 무화학·논오일·논실리콘으로 매일 뿌리기 부담이 적습니다. 용량 235ml, 엄마와 아이가 함께 쓸 수 있도록 만들었습니다.",
    pillarsHeading: "네 가지 케어",
    pillars: [
      {
        title: "올내추럴",
        copy: "넣을 것을 더하기보다, 모발에 남는 화학 부담을 먼저 덜었습니다.",
      },
      {
        title: "모든 모발 타입",
        copy: "가는 모발부터 굵고 손상된 결까지, 타입을 가리지 않고 뿌리도록 설계했습니다.",
      },
      {
        title: "윤기",
        copy: "푸석한 표면에 수분을 더해, 보석처럼 빛나는 머리결을 돕습니다.",
      },
      {
        title: "모발 강화",
        copy: "저분자 수분이 결에 머물며, 힘이 빠진 모발을 탄탄하게 가꿔 가도록 돕습니다.",
      },
    ],
    symptomsHeading: "이런 결이라면,\n미스트를 가까이 두세요",
    symptomsLead:
      "샴푸 직후가 아니어도, 하루 사이에 윤기가 달아나는 모발에 맞춰 만들었습니다.",
    symptoms: [
      "모발이 푸석하고 윤기가 없다",
      "손상된 결이 거칠고 힘이 없다",
    ...
    freeItems: [
      {
        title: "무화학",
        copy: "모발에 남는 화학 부담을 덜도록, 불필요한 합성 성분을 넣지 않았습니다.",
      },
      {
        title: "논오일",
      ...
      {
        title: "논실리콘",
        copy: "실리콘으로 일시적인 매끄러움을 만들지 않습니다. 수분으로 윤기를 돕습니다.",
      },
    ],
    pointsHeading: "뿌리기만 해도\n결이 달라지는 이유",
    pointsLead: "큐티클을 연 다음, 이온과 저분자 수분이 손상된 결에 닿도록 설계했습니다.",
    points: [
      {
        index: "01",
        title: "큐티클을 여는 미스트",
        copy: "분사와 함께 모발 큐티클이 부드럽게 열리도록 도와, 다음 수분 케어가 결에 닿기 쉽게 합니다.",
      },
      {
        index: "02",
        title: "이온과 저분자 수분의 결합",
        copy: "손상된 모발 표면의 양이온과 미스트의 마이너스 이온, 저분자 수분이 만나 결에 수분이 머물도록 돕습니다.",
      },
      {
        index: "03",
        title: "분사 후 브러싱",
        copy: "뿌린 뒤 빗질하면 미스트가 모발 전체에 얇게 퍼지고, 큐티클이 다시 정돈됩니다.",
      },
    ],
    howHeading: "사용 방법",
    howNote:
      "235ml 한 병. 젖은 모발과 마른 모발 모두에 뿌릴 수 있습니다. 엄마와 아이가 함께 쓰기 좋게 만들었습니다.",
    howSteps: [
      "모발에서 20cm 정도 떨어뜨려, 중간부터 끝까지 고르게 분사합니다.",
      "손끝이나 브러시로 결을 따라 빗질해, 미스트가 모발 전체에 퍼지게 합니다.",
      "스타일링 전·후에도 가볍게 뿌려 윤기를 더할 수 있습니다.",
    ],
    cautionHeading: "주의 사항",
    cautions: [
      "눈과 점막을 피해 분사하세요.",
      "뿌린 뒤에는 반드시 브러싱해 결을 정리하세요.",
    ],
  ...
  "scalp-balance-tonic": {
    ...
    heading: "맑고 투명한 피부는\n수분으로 지워요",
    intro:
      "엔클로이 버블 워시는 보습과 다당체 거품으로 세안과 바디, 아이까지 함께 쓰는 클렌저입니다. 모공 주변의 노폐물을 거품이 감싸 씻어내도록 돕고, 손가락 지문이 피부에 직접 닿지 않게 롤링합니다.",
    pillarsHeading: "네 가지 세정",
    pillars: [
      {
        title: "보습 세정",
        copy: "지우는 세안이 아니라, 수분을 남기는 세안입니다. 씻은 뒤에도 당김이 덜하도록 설계했습니다.",
      },
      {
        title: "다당체 거품",
        copy: "입자가 큰 다당체 거품이 모공 입구의 노폐물을 감싸, 블랙헤드처럼 보이는 피지 찌꺼기를 씻어내는 데 도움을 줍니다.",
      },
      {
        title: "세안 + 바디 + 아이",
        copy: "얼굴과 바디, 아이가 같은 거품으로 씻을 수 있도록 만든 올인원 워시입니다.",
      },
      {
        title: "거품 롤링",
        copy: "손가락 지문이 피부에 닿지 않게, 거품만 올려 굴리듯 롤링합니다.",
      },
    ],
    symptomsHeading: "이런 세안이라면,\n거품부터 바꿔 보세요",
    symptomsLead:
      "강하게 문질러 지우는 세안 대신, 수분과 거품으로 감싸 씻는 방식입니다.",
    symptoms: [
      "세안 후 피부가 당기고 건조하다",
    ...
    points: [
      {
        index: "01",
        title: "수분으로 지운다",
        copy: "맑고 투명한 피부는 수분으로 지워요. 보습 세정이 당김을 덜고 다음 케어가 닿기 쉽게 합니다.",
      },
      {
        index: "02",
        title: "다당체 거품으로 모공",
        copy: "거품이 모공 주변의 노폐물·피지를 감싸 씻어내, 블랙헤드처럼 보이는 피지 찌꺼기를 덜어 주도록 돕습니다. 짜거나 박피하는 세안이 아닙니다.",
      },
      {
        index: "03",
        title: "지문이 피부에 닿지 않게",
        copy: "손가락 지문으로 문지르면 자극이 됩니다. 거품만 피부에 올려 굴리듯 롤링하세요.",
      },
    ],
    howHeading: "사용 방법",
    howNote:
      "세안과 바디, 아이까지 같은 거품으로 쓸 수 있습니다. 공통점은 비비지 않고, 거품을 롤링하는 것입니다.",
    howGroups: [
      {
        ...
        steps: [
          ...
          "손가락 지문이 피부에 닿지 않도록, 거품만 올려 원을 그리듯 롤링합니다.",
          "미온수로 거품이 남지 않게 헹굽니다.",
        ],
      },
      {
        title: "메이크업을 했을 때 · 더블 세안",
        note: "메이크업이 있으면 한 번에 지우기보다, 두 번으로 나눠 감싸 씻습니다.",
        steps: [
          "첫 번째 거품으로 메이크업을 부드럽게 감싸 씻어내고, 미온수로 헹굽니다.",
          "두 번째 거품을 다시 내, 지문이 닿지 않게 롤링하며 남은 노폐물을 씻습니다.",
          "미온수로 깨끗이 헹굽니다.",
        ],
      },
    ],
    ...
    cautions: [
      ...
      "사용 초기에 피부가 당기거나 얇은 각질이 일어나는 느낌이 있을 수 있습니다. 피부 컨디션이 바뀌는 과정에서 나타날 수 있으나, 불편함이 크면 사용을 멈추고 전문가와 상담하세요.",
  ...
  "volume-lift-essence": {
    ...
    heading: "오일 NO, 수분 OK",
    intro:
      "오일과 알코올은 순간적으로 부드러워 보여도, 피부를 건조하게 만들 수 있습니다. 스킨&바디 보습 로션은 무오일 보습으로 각질층에 수분을 남기고, 식물 미네랄의 항산화와 당 성분의 수분 흡착으로 촉촉함을 이어 갑니다.",
    ...
    pillars: [
      ...
      {
        title: "각질층 케어",
        copy: "겉만 번들거리게 하지 않고, 각질층이 수분을 붙잡는 힘을 보태도록 설계했습니다.",
      },
      {
        title: "식물 미네랄 항산화",
    ...
    symptomsHeading: "오일 보습이\n오히려 건조하다면",
    symptomsLead:
      "오일이나 알코올이 많은 로션을 오래 쓰면, 피부는 순간적으로 부드러워 보여도 수분을 잃기 쉽습니다.",
    symptoms: [
      "바르면 번들거리지만 곧 땅긴다",
    ...
    points: [
      {
        index: "01",
        title: "오일 NO, 수분 OK",
        copy: "오일 대신 수분과 당 성분으로 보습합니다. 바른 뒤 무겁지 않고, 각질층이 촉촉함을 붙잡도록 돕습니다.",
      },
      {
        index: "02",
        title: "유화제 없는 화장품에 도전",
        copy: "물과 기름을 억지로 섞는 유화 대신, 오일 없이 수분이 스스로 자리를 잡도록 만든 처방입니다.",
      },
      {
        index: "03",
        title: "샤워 후 바로",
    ...
    scienceCopy: [
      "식물 미네랄은 항산화 케어로 스킨과 바디의 컨디션을 오래 건강하게 유지하도록 돕습니다.",
      "대표적인 산화 방지제 아스코르빈산나트륨(비타민 C)의 ORP는 사용 후 약 +50mV입니다. 식물 미네랄은 약 −600mV의 환원력을 지닙니다.",
    ],
    scienceFootnote: ORP_FOOTNOTE,
    howHeading: "사용 방법",
    howNote: "실온에 보관하세요. 냉장 보관은 필요하지 않습니다.",
    howSteps: [
      "샤워 후, 물기를 살짝 남긴 스킨과 바디에 적당량을 덜어 펴 바릅니다.",
      "손이 가는 대로 두드리기보다, 결을 따라 얇게 펴 바르는 편이 흡착에 좋습니다.",
      "건조하다고 느껴지는 부위에는 한 겹 더 올립니다.",
    ],
    cautionHeading: "주의 사항",
    cautions: [
      "실온에서 보관하세요.",
  ...
  "hydra-calming": {
    ...
    heading: "악순환을 멈추고,\n턴오버가 제자리를 찾도록",
    intro:
      "클로이 두피 팩은 아미노산과 당, 다당류로 각질층의 수분 균형을 돕습니다. 삼투압 케어로 모공 주변의 노폐물 배출을 돕고, 흐트러진 턴오버 리듬이 제자리를 찾도록 설계했습니다. 샴푸와 함께 쓰면 세정과 팩이 서로를 보탭니다.",
    pillarsHeading: "네 가지 구성",
    pillars: [
      {
        title: "아미노산",
        copy: "피부와 가까운 아미노산이 두피 각질층의 컨디션을 보태도록 돕습니다.",
      },
      {
        title: "당",
      ...
      {
        title: "다당류",
        copy: "다당류가 수분을 붙잡고, 팩의 텍스처가 두피에 고르게 머물게 합니다.",
      },
      {
        title: "삼투압 · 각질층",
    ...
    symptomsHeading: "문제가 쌓이면\n모공은 더 막힙니다",
    symptomsLead:
      "노폐물이 모공을 막고, 턴오버가 흐트러지면, 같은 고민이 반복되기 쉽습니다. 팩은 그 고리를 느슨하게 하도록 돕습니다.",
    symptoms: [
      "두피 모공이 막히고 답답하다",
      "각질이 일어나며 컨디션이 널뛴다",
    ...
    freeHeading: "화학 성분을 비우고,\n여섯 가지를 뺐습니다",
    freeLead:
      "두피에 부담이 될 수 있는 오일, 방부제, 향료, 알코올, 색소, 합성 계면활성제를 넣지 않았습니다.",
    ...
    points: [
      {
        index: "01",
        title: "오일 · 화학 NO",
        copy: "오일 막과 불필요한 화학 잔여 없이, 두피가 스스로 숨 쉴 자리를 남깁니다.",
      },
      {
        index: "02",
        title: "모공",
        copy: "삼투압 케어가 모공 주변의 노폐물 배출을 도와, 막힌 느낌이 덜해지도록 합니다.",
      },
      {
        index: "03",
        title: "턴오버",
        copy: "피부 각질층은 대략 한 달 주기로 새로워집니다. 팩은 그 리듬이 크게 흐트러지지 않도록 수분과 아미노산 케어로 돕습니다.",
      },
      {
        index: "04",
        title: "미네랄",
    ...
    scienceHeading: "배설과 세정이\n서로를 보탤 때",
    scienceLead: "팩만으로 끝내지 마세요. 샴푸와 짝을 이루도록 만들었습니다.",
    scienceCopy: [
      "삼투압 케어는 각질층 안팎의 농도 차이로 노폐물이 바깥으로 나가기 쉽게 돕습니다. 밀어 넣는 침투보다, 비우고 순환하는 쪽에 가깝습니다.",
      "이어서 샴푸로 세정하면 팩이 느슨하게 한 노폐물을 거품이 감싸 씻어 내기 좋습니다. 두 제품이 같은 방향의 케어입니다.",
      "식물 미네랄의 ORP는 약 −600mV로, 비타민 C(사용 후 약 +50mV)보다 환원 쪽으로 기울어 있습니다.",
    ],
    scienceFootnote: ORP_FOOTNOTE,
    howHeading: "사용 방법",
    howNote:
    ...
    howSteps: [
      ...
      "엔클로이 두피 샴푸로 거품을 내 세정한 뒤, 미온수로 헹굽니다.",
    ],
    cautionHeading: "주의 사항",
    cautions: [
      "두피를 세게 비비지 마세요.",
  ...
  "radiance-serum": {
    ...
    heading: "침투보다 순환.\n피부를 비워 다시 채우다",
    intro:
      "엔클로이 얼굴 팩은 성분을 억지로 밀어 넣기보다, 삼투압으로 노폐물 배출과 순환을 돕는 팩입니다. 아미노산과 당, 식물 미네랄, 다당체가 각질층의 보습과 항산화, 턴오버 케어를 함께 합니다.",
    pillarsHeading: "네 가지 케어",
    pillars: [
      {
        title: "순환 중심",
        copy: "더 바르는 침투보다, 막힌 것을 비워 피부가 순환하도록 돕는 쪽에 가깝습니다.",
      },
      {
        title: "삼투압 배출",
    ...
    points: [
      ...
      },
      {
        index: "04",
        title: "턴오버 · 각질층",
        copy: "대략 한 달 주기의 턴오버가 크게 흔들리지 않도록, 각질층의 보습 균형을 돕습니다.",
      },
    ],
    scienceKicker: "삼투압",
    scienceHeading: "밀어 넣지 않고,\n나가기 쉽게",
    scienceLead: "침투를 자랑하는 팩과 출발점이 다릅니다.",
    scienceCopy: [
      "성분을 각질 아래로 밀어 넣는 이야기보다, 삼투압으로 노폐물 배출과 순환을 돕는 이야기에 가깝습니다.",
      "아미노산과 당, 미네랄, 다당체가 그 순환 위에 보습과 항산화를 얹습니다. 개인차가 있으며, 질병의 치료나 예방을 약속하지 않습니다.",
    ],
    howHeading: "사용 방법",
