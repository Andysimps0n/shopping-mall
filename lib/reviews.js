...
export const reviews = [
  ...
  },
  {
    ...
    date: "2026.08.18",
    title: "샤워 후 당김이 없어요",
    body: "오일 없는 로션이라 처음엔 보습이 약할까 싶었는데, 바른 뒤에도 촉촉함이 오래 가요. 끈적임 없이 몸 전체에 잘 발립니다.",
  },
  {
    id: "volume-2",
    productId: "volume-lift-essence",
    ...
    rating: 4,
    date: "2026.07.01",
    title: "손과 팔에 매일 쓰고 있어요",
    body: "건조한 손에 수시로 바르기 좋아요. 향이 거의 없고 흡수가 빨라서 옷에 묻을 걱정이 적습니다.",
  },
  {
    id: "volume-3",
    productId: "volume-lift-essence",
    ...
    rating: 5,
    date: "2026.06.11",
    title: "민감한 날에도 부담이 없어요",
    body: "알코올 향이 없고 오일막이 남지 않아서 환절기에도 자극이 덜합니다. 실온에 두고 쓰기 편해요.",
  },
  {
    id: "tonic-1",
  ...
  {
    id: "toner-1",
    productId: "hydra-calming",
    author: "노지아",
    rating: 5,
    date: "2026.08.25",
    title: "샴푸 후 두피가 편해졌어요",
    body: "샴푸만 쓸 때보다 팩을 올린 뒤 가려움이 덜합니다. 향료가 없어서 예민한 날에도 부담이 없어요.",
  },
  {
    id: "toner-2",
    productId: "hydra-calming",
    ...
    date: "2026.07.16",
    title: "모공이 열린 느낌이 나요",
    body: "묵직하던 두피가 한결 가벼워졌어요. 오일막이 남지 않아서 다음 날 샴푸도 개운합니다.",
  },
  {
    id: "toner-3",
    productId: "hydra-calming",
    ...
    date: "2026.06.02",
    title: "장벽이 안정된 느낌이에요",
    body: "주 2~3회 헤어팩처럼 쓰고 있습니다. 알코올 자극이 없고, 두피 컨디션이 일정하게 유지되는 점이 좋아요.",
  },
  {
    id: "serum-1",
