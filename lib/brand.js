...
export const brand = {
  ...
  lineupImage: "/brand/lineup.jpg",
  lineupAlt:
    "앤클로이 버블 워시, 두피 샴푸, 모이스춰 로션, 페이스 팩, 스칼프 팩, 헤어 미스트 라인업",
  ...
  turnoverKicker: "TURNOVER",
  turnoverHeading: "왜 문제성 피부로 변하는 걸까요?",
  turnoverLead:
    "화학 물질과 오일이 피부에 쌓이면 세포 활동이 느려지고, 이어서 턴오버가 흔들립니다. 장벽이 약해지고 모공이 막히면 피부는 점차 예민해집니다.",
  ...
  turnoverItems: [
    {
      index: "01",
      title: "턴오버란",
      copy: "기저층에서 만들어진 세포가 여러 과정을 거쳐 각질층 바깥에서 자연스럽게 떨어지는 일련의 리듬입니다. 이 리듬이 건강하면 피부는 촉촉하고 맑은 상태를 유지하기 쉽습니다.",
    },
    {
      index: "02",
      title: "리듬이 깨지는 이유",
      copy: "자외선, 합성 계면활성제, 오일류가 땀과 피지, 노폐물의 배출을 막고 각질층의 생리를 떨어뜨릴 수 있습니다.",
    },
    {
      index: "03",
      title: "우선해야 할 일",
      copy: "유효 성분을 더 바르는 것은 근본 해결이 아닙니다. 손상된 각질층을 되돌리고 막힌 모공을 열어, 턴오버를 정상화하는 일이 먼저입니다.",
    },
  ],
