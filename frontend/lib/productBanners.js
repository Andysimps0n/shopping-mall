...
//
// Catalog coverage:
//   silk-repair-shampoo      — 앤클로이 두피 샴푸 (existing)
...
const bannersByProductId = {
  ...
  "moisture-glow-treatment": {
    ...
    intro:
      "화학물질과 오일, 실리콘 성분이 전혀 없는 무첨가 두피 모발 미스트로 식물추출 미네랄은 다량의 마이너스 이온을 함유하여 손상 모발을 건강한 모발로 환원시킵니다. 수분과 음이온이 잘 정착된 모발은 반짝반짝 빛이 나며 늘 찰랑거리는 상태로 유지됩니다.",
    images: [
    ...
    howHeading: "사용 방법",
    howSteps: [
      "샴푸후 타올로 머리의 물기를 제거합니다.",
      "두피와 모발 전체에 미스트를 충분히 뿌린 후 드라이어로 말려줍니다.",
    ],
    cautionHeading: "주의 사항",
    cautions: [
      "눈과 점막을 피해 분사하세요.",
  ...
  "scalp-balance-tonic": {
    ...
    intro:
      "세상에서 가장 선한 클렌저. 물로 기름을 씻어내는 무오일의 깨끗한 거품 세정. 다당체 포집을 통해 각질층의 손상 없이 막힌 모공을 뚫어 냅니다. 메이크업은 물론 세안, 샴푸, 바디 샤워, 여성청결제 기능까지 피부 타입에 관계없이 온가족이 함께 사용하실 수 있는 약산성 세정제로 논오일과 천연을 실현했습니다. 아미노산계 세정 성분과 다당류가 피부를 자극 없이 씻어주고 식물 미네랄의 강력한 항산화 효과로 피부를 투명하고 건강하게 유지시켜줍니다.",
    images: [
    ...
    ingredientsHeading: "전성분",
    ingredients:
      "정제수, 소듐코코일글루타메이트, 포타슘코코일글루타메이트, 글루코오스, 덱스트린, 사이클로덱스트린, 트레할로스, 말티톨, 글리세린, 알란토인, 카프릴릴글라이콜, 다이메틸설폰, 글루타믹애씨드, 알라닌, 글라이신, 프롤린, 트립토판, 알지닌, 식물재추출물",
  },
  ...
  "volume-lift-essence": {
    ...
    scienceFootnote: ORP_FOOTNOTE,
    howHeading: "사용 방법",
    howNote: "개봉 후에는 냉장보관하시고, 가급적 빨리 사용하십시오.",
    howSteps: [
