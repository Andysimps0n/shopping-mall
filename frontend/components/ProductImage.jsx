 ...
 * @param {number} [props.zoom] Scale the photo up (e.g. 1.5) when the studio shot has too much whitespace.
...
export default function ProductImage({
  ...
  // Zoom crops into the center. Parent already has overflow: hidden.
  const photoStyle =
